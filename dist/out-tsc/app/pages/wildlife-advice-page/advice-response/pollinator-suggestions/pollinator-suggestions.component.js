...
let PollinatorSuggestionsComponent = class PollinatorSuggestionsComponent {
    ...
    chooseRandomFirst(i, recursiveBackstop, retrievedAnswers, ourMonthDisplay) {
        ...
        let tempDisplay = retrievedAnswers[i][rand];
...
], PollinatorSuggestionsComponent.prototype, "ngOnDestroy", null);
__decorate([
    Output()
], PollinatorSuggestionsComponent.prototype, "newSaveEvent", void 0);
__decorate([
    Output()
], PollinatorSuggestionsComponent.prototype, "newRemoveEvent", void 0);
PollinatorSuggestionsComponent = __decorate([
    Component({
...
export { PollinatorSuggestionsComponent };
//# sourceMappingURL=pollinator-suggestions.component.js.map